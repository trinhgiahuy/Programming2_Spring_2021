...
public:
    ...
    // In destruction the drop removes itself from the data content of the game board.
    void removeDrop(int x, int y);

    // Fetches the drop instance from the board at given coordinates, or a nullptr if the coordinates
...
public slots:
    // Activated, when water is needed to be added to the board at the given position.
...
private:
    ...
    // Prints the game board to the given stream by animating the flow of splashes
