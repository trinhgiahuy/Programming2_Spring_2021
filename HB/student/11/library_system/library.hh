...
private:
	...
	// Loaning data including: 
	// 		loaned books,
	//		person who borrowed the book and due date of the loan
	// Key is title of the book that is loaned
	std::map<std::string, Loan*> loaning_data_;
};
